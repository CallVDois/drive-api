...
import com.callv2.drive.application.folder.usecase.sharing.remove.DefaultRemoveFolderSharingUseCase;
...
public class FolderUseCaseConfig {
    ...
    @Bean
    RemoveFolderSharingUseCase removeFolderSharingUseCase() {
        return new DefaultRemoveFolderSharingUseCase(
                eventDispatcher,
                folderGateway,
                aclGateway);
    }
